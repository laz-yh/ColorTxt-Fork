...
仅将明显乱码替换为合理汉字；无法确定时删除或保留，不要编造。

## 还原 * 屏蔽

正文中因和谐用 * 代替的字/词，在上下文明确时尽量还原；勿动整行 * 分隔线。不确定时保留，不要编造。

## 移除盗版水印

删除句中插入的防盗版/反采集杂符（圈号、生僻字夹符号、中英数字乱混等）；勿删正文与章节分隔线；不要还原含义，不确定时保留。

## 移除广告/引流

删除明显站宣/水印/引流行（域名、求点击、聚合站口号等）。系统启用本子任务时会另行说明细则。
